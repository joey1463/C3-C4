# This script will compute differentially exrpessed genes for each identified cell type 
...
subcluster_and_DE<-function(subcluster_sorghum_combined, target_subclusters, chosen_cluster){
  ...
  # Saving Output
  save(subcluster_sorghum_combined_CI, file = paste(paste(chosen_cluster, sep="", collapse=""),"CI.RData",sep='_'))
