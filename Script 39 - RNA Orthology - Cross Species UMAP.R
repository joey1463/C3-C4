...
FeaturePlot(object = species_combined, features = "LOC-Os01g09320", min.cutoff = 0, raster=FALSE, split.by = 'Time') #NADPME
...
DimPlot(object = species_combined, reduction = "umap", label=FALSE, raster = FALSE, cols = colors[,3]) 
