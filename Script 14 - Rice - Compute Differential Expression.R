...
subcluster_and_DE<-function(subcluster_rice_combined, targets, chosen_cluster){
  ...
  save(subcluster_rice_combined_CI, file = paste(paste(chosen_cluster, sep="", collapse=""),"CI.RData",sep='_'))
